...
class Policy(Base):
	...
	# Phase 2 ranking metadata (stable identity fields)
	authority_level: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
	department_scope: Mapped[str] = mapped_column(String(128), nullable=False, default="all")
	policy_type: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
	...
	__table_args__ = (
		...
		Index("ix_policies_department_scope", "department_scope"),
		Index("ix_policies_authority_level", "authority_level"),
	)
