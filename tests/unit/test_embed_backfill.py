...
def _sample_rows():
    return [
        SimpleNamespace(
            ...
            content_sha256="abc",
            section_text="Members may file an appeal within 90 days.",
            section_title="Member Appeals",
            effective_date=None,
            authority_level=80,
        ...
        SimpleNamespace(
            ...
            policy_version_id=uuid4(),
            content_sha256="def",
            section_text="Expedited path available for urgent appeals.",
            section_title="Expedited",
            effective_date=None,
            authority_level=60,
